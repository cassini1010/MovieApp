...
class Moive_actors_link(SQLModel, table=True):
    ...
    movie_id: Annotated[int|None, Field(default=None, foreign_key="movie.id", ondelete="CASCADE")]
    actor_id: Annotated[int|None, Field(default=None, foreign_key="actor.id", ondelete="CASCADE")]


class Movie_genre_link(SQLModel, table=True):
    id: Annotated[int | None, Field(default=None, primary_key=True)]
    movie_id: Annotated[int|None, Field(default=None, foreign_key="movie.id", ondelete="CASCADE")]
    genre_id: Annotated[int|None, Field(default=None, foreign_key="genre.id", ondelete="CASCADE")]
...
class Genre(SQLModel, table=True):
    ...
    # Relations
    movies: list["Movie"] = Relationship(back_populates="genres", link_model=Movie_genre_link)
...
class Actor(SQLModel, table=True):
    ...
    # Relations
    movies: list["Movie"] = Relationship(back_populates="actors", link_model=Moive_actors_link)
...
class Movie(SQLModel, table=True):
    ...
    genres: list[Genre] = Relationship(back_populates="movies", link_model=Movie_genre_link)
